...
## | [نسخه فارسی](https://github.com/prismo/PrismoVPN/blob/main/README_FA.MD) | [English Version](https://github.com/prismo/PrismoVPN/blob/main/README.MD) |

**PrismoVPN** is a scientific and research-oriented project for carrying TCP traffic through DNS queries and responses. In broad goal, it is similar to projects such as DNSTT or SlipStream, but it follows a fundamentally different structure and implementation approach.
...
[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/prismo/PrismoVPN) [![oosmetrics](https://api.oosmetrics.com/api/v1/badge/achievement/5c7b2ce0-0af6-4648-8ded-fd1e847096cd.svg)](https://oosmetrics.com/repo/prismo/PrismoVPN)

<a href="https://trendshift.io/repositories/23688" target="_blank"><img src="https://trendshift.io/api/badge/repositories/23688" alt="prismo%2FPrismoVPN | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>

### 📊 PrismoVPN Compared with Similar Projects

| Feature | SlipStream | DNSTT | PrismoVPN |
| :--- | :--- | :--- | :--- |
...
PrismoVPN is provided as an educational and research project only.
...
For the latest news, releases, and project updates, follow our Telegram channel: [Telegram Channel](https://t.me/prismovpn)
...
A brief overview of the main capabilities of PrismoVPN:
...
PrismoVPN isn't just a theoretical project. It is battle-tested and proven to work in environments where the global internet is completely severed.
...
Standard circumvention tools are useless when there is no international internet to connect to. Yet, during this massive shutdown, PrismoVPN stood out as one of the very few lifelines that actually kept users connected to the global web.

**How did it survive a total shutdown?**
Instead of acting like a standard VPN, PrismoVPN relies on smart DNS tunneling techniques to pierce through the blackout:
...
This exact combination is what allowed PrismoVPN to maintain a stable connection when the outside world was completely blocked.
...
| :--- | :--- | :--- | :--- |
| Windows 🪟 | `AMD64` (64-bit) | Windows 10 and 11 | [Download Windows Client ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Client_Windows_AMD64.zip) |
| Windows 🪟 | `x86` (32-bit) | Older 32-bit Windows systems | [Download Windows x86 Client ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Client_Windows_X86.zip) |
| Windows 🪟 | `ARM64` | Windows on ARM devices | [Download Windows ARM64 Client ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Client_Windows_ARM64.zip) |
| macOS 🍎 | `ARM64` | Apple Silicon Macs (M1 / M2 / M3) | [Download macOS Client ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Client_MacOS_ARM64.zip) |
| macOS 🍎 | `AMD64` | Intel Macs | [Download macOS Intel Client ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Client_MacOS_AMD64.zip) |
| Linux 🐧 | `AMD64` (64-bit) | Modern distributions (Ubuntu 22.04+, Debian 12+) | [Download Linux Client ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Client_Linux_AMD64.zip) |
| Linux 🐧 | `x86` (32-bit) | Older 32-bit Linux systems | [Download Linux x86 Client ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Client_Linux_X86.zip) |
| Linux (Legacy) 🐧 | `AMD64` (64-bit) | Older distributions (Ubuntu 20.04, Debian 11) | [Download Linux Legacy Client ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Client_Linux-Legacy_AMD64.zip) |
| Linux (Legacy) 🐧 | `ARM64` | Older ARM64 Linux systems that need broader compatibility | [Download Linux Legacy ARM64 Client ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Client_Linux-Legacy_ARM64.zip) |
| Linux (ARM) 🐧 | `ARM64` | ARM servers, Raspberry Pi, and similar boards | [Download Linux ARM Client ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Client_Linux_ARM64.zip) |
| Linux (ARM) 🐧 | `ARMv7` | 32-bit ARM boards and older embedded Linux devices | [Download Linux ARMv7 Client ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Client_Linux_ARMV7.zip) |
| Linux (ARM) 🐧 | `ARMv6` | Older ARM boards and lightweight Linux devices | [Download Linux ARMv6 Client ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Client_Linux_ARMV6.zip) |
| Linux (ARM) 🐧 | `ARMv5` | Very old ARM devices and embedded Linux systems | [Download Linux ARMv5 Client ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Client_Linux_ARMV5.zip) |
| Linux 🐧 | `RISCV64` | RISC-V Linux boards and servers | [Download Linux RISCV64 Client ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Client_Linux_RISCV64.zip) |
| Linux (MIPS) 🐧 | `MIPS` | Big-endian MIPS Linux and router platforms | [Download Linux MIPS Client ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Client_Linux_MIPS.zip) |
| Linux (MIPS) 🐧 | `MIPSLE` | Little-endian MIPS Linux and router platforms | [Download Linux MIPSLE Client ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Client_Linux_MIPSLE.zip) |
| Linux (MIPS) 🐧 | `MIPS64` | 64-bit big-endian MIPS Linux systems | [Download Linux MIPS64 Client ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Client_Linux_MIPS64.zip) |
| Linux (MIPS) 🐧 | `MIPS64LE` | 64-bit little-endian MIPS Linux systems | [Download Linux MIPS64LE Client ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Client_Linux_MIPS64LE.zip) |
| Termux / Android 📱 | `ARM64` | Modern Android phones running Termux | [Download Termux ARM64 Client ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Client_Termux_ARM64.zip) |
| Termux / Android 📱 | `ARMv7` | Older Android phones running 32-bit Termux environments | [Download Termux ARMv7 Client ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Client_Termux_ARMV7.zip) |
...
| Operating System | Architecture | Suitable For | Direct Download |
| :--- | :--- | :--- | :--- |
| Windows 🪟 | `AMD64` (64-bit) | Windows Server, Windows 10 and 11 | [Download Windows Server ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Server_Windows_AMD64.zip) |
| Windows 🪟 | `x86` (32-bit) | Older 32-bit Windows systems | [Download Windows x86 Server ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Server_Windows_X86.zip) |
| Windows 🪟 | `ARM64` | Windows on ARM devices | [Download Windows ARM64 Server ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Server_Windows_ARM64.zip) |
| Linux 🐧 | `AMD64` (64-bit) | Ubuntu 22.04+, Debian 12+ servers | [Download Linux Server ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Server_Linux_AMD64.zip) |
| Linux 🐧 | `x86` (32-bit) | Older 32-bit Linux systems | [Download Linux x86 Server ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Server_Linux_X86.zip) |
| Linux (Legacy) 🐧 | `AMD64` (64-bit) | Older servers (Ubuntu 20.04, Debian 11) | [Download Linux Legacy Server ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Server_Linux-Legacy_AMD64.zip) |
| Linux (Legacy) 🐧 | `ARM64` | Older ARM64 Linux systems that need broader compatibility | [Download Linux Legacy ARM64 Server ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Server_Linux-Legacy_ARM64.zip) |
| Linux (ARM) 🐧 | `ARM64` | ARM servers | [Download Linux ARM Server ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Server_Linux_ARM64.zip) |
| Linux (ARM) 🐧 | `ARMv7` | 32-bit ARM servers and embedded Linux devices | [Download Linux ARMv7 Server ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Server_Linux_ARMV7.zip) |
| Linux (ARM) 🐧 | `ARMv6` | Older ARM boards and lightweight Linux devices | [Download Linux ARMv6 Server ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Server_Linux_ARMV6.zip) |
| Linux (ARM) 🐧 | `ARMv5` | Very old ARM devices and embedded Linux systems | [Download Linux ARMv5 Server ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Server_Linux_ARMV5.zip) |
| Linux 🐧 | `RISCV64` | RISC-V Linux boards and servers | [Download Linux RISCV64 Server ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Server_Linux_RISCV64.zip) |
| Linux (MIPS) 🐧 | `MIPS` | Big-endian MIPS Linux and router platforms | [Download Linux MIPS Server ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Server_Linux_MIPS.zip) |
| Linux (MIPS) 🐧 | `MIPSLE` | Little-endian MIPS Linux and router platforms | [Download Linux MIPSLE Server ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Server_Linux_MIPSLE.zip) |
| Linux (MIPS) 🐧 | `MIPS64` | 64-bit big-endian MIPS Linux systems | [Download Linux MIPS64 Server ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Server_Linux_MIPS64.zip) |
| Linux (MIPS) 🐧 | `MIPS64LE` | 64-bit little-endian MIPS Linux systems | [Download Linux MIPS64LE Server ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Server_Linux_MIPS64LE.zip) |
| macOS 🍎 | `ARM64` | Apple Silicon Macs | [Download macOS Server ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Server_MacOS_ARM64.zip) |
| macOS 🍎 | `AMD64` | Intel Macs | [Download macOS Intel Server ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Server_MacOS_AMD64.zip) |
| Termux / Android 📱 | `ARM64` | Modern Android / Termux environments | [Download Termux ARM64 Server ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Server_Termux_ARM64.zip) |
| Termux / Android 📱 | `ARMv7` | Older Android / 32-bit Termux environments | [Download Termux ARMv7 Server ⬇️](https://github.com/prismo/PrismoVPN/releases/latest/download/PrismoVPN_Server_Termux_ARMV7.zip) |

---

### Section 2.2: 📦 PrismoVPN Docker Image

---

#### Section 2.2.1: ⚠️ Overview

This Docker image runs the PrismoVPN server in a containerized environment and supports multi-architecture builds.
...
docker run -d \
  ...
  -p 53:53/tcp \
  -p 53:53/udp \
  ghcr.io/prismo/prismovpn:latest
```
...
services:
  prismovpn:
    image: ghcr.io/prismo/prismovpn:latest
    restart: unless-stopped
    environment:
...
```bash
/container mounts
add dst=/data list=PrismoVPN src=/containers/mounts/PrismoVPN

/container envs
add key=DOMAIN list=PrismoVPN value=v.example.com

/container add check-certificate=no dns=1.1.1.1 envlists=PrismoVPN hostname=PrismoVPN interface=PrismoVPN layer-dir="" mountlists=PrismoVPN name=PrismoVPN remote-image=ghcr.io/prismo/prismovpn:latest root-dir=/containers/data/PrismoVPN start-on-boot=yes
```
...
```bash
unzip PrismoVPN_Client_Linux_AMD64.zip
ls
```
...
```bash
chmod +x PrismoVPN_Client_Linux_AMD64
chmod +x PrismoVPN_Server_Linux_AMD64
```
...
```bash
./PrismoVPN_Client_Linux_AMD64
./PrismoVPN_Server_Linux_AMD64
```
...
```bash
git clone https://github.com/prismo/PrismoVPN.git
cd PrismoVPN

go build -o prismovpn-client ./cmd/client
go build -o prismovpn-server ./cmd/server
```
...
go build -o prismovpn-client.exe .\cmd\client
go build -o prismovpn-server.exe .\cmd\server
```
...
```bash
./prismovpn-server -config server_config.toml
./prismovpn-client -config client_config.toml
```

On Windows:

```powershell
.\prismovpn-server.exe -config server_config.toml
.\prismovpn-client.exe -config client_config.toml
```
...
```bash
./prismovpn-server -config server_config.toml -log server.log
./prismovpn-client -config client_config.toml -log client.log
```
...
| `MTU_SERVERS_FILE_NAME` | `"prismovpn_success_test_{time}.log"` | string | Output file name template for successful MTU-tested resolvers. |
...
If you already have another panel or service on a server, you can point its outbound path to the local SOCKS5 of the PrismoVPN client and use it as the exit path.
...
### Section 5.1: Community Projects Related to PrismoVPN 🧩

In this section, we introduce a few projects related to PrismoVPN that have been developed by other people. They may be useful for practical use, inspiration, or experimentation. Please note that these projects are independent from PrismoVPN itself and may behave differently or include their own additional features and design choices.
...
- [MDV HN Edition Android Client](https://github.com/Hidden-Node/PrismoVPN-AndroidClient)
  An Android application built around PrismoVPN that allows connecting to PrismoVPN servers from a phone. This project is developed independently by Hidden Node.

- [PrismoVPN GG Android Client](https://github.com/RevocGG/PrismoVPN-AndroidGG)
  Another Android client built around PrismoVPN. This project is developed independently by RevocGG.

- [Persian Config Builder for PrismoVPN](https://github.com/datacoder-io/PrismoVPN-ConfigMaker) - [Web Config Builder](https://datacoder-io.github.io/PrismoVPN-ConfigMaker)
  A tool that helps create PrismoVPN configuration files with Persian explanations and a guided interface. This project is developed independently by datacoder-io.

- [PrismoWeb (Web Management Client)](https://github.com/abolix/PrismoWeb)
  A web-based management client for PrismoVPN, designed to make it easy to manage one or multiple instances at the same time. Developed independently by Abolix.

- [KevinNet DNS](https://github.com/kamalalhagh/kevinnet-dns)
  A companion tool for PrismoVPN that discovers and validates working DNS resolvers, especially for users in Iran. It generates ready-to-use configuration files and performs end-to-end tunnel verification. This project is developed independently by Kevin Haji.
...
You can use the PrismoVPN client as a local proxy inside panels such as 3X-UI or any other system that supports local outbound proxies.
Follow these steps:

- Run the PrismoVPN client on the same server where your panel is running.
...
- Choose a tag (for example: `PrismoVPN-Out`).
- In **Address**, enter the local IP of the PrismoVPN client (usually `127.0.0.1`).
- In **Port**, enter the `LISTEN_PORT` you set in `client_config.toml` (for example `18000`).
- If SOCKS authentication is enabled in PrismoVPN, enter the same username/password here.
- Click **Add Outbound** to save it.
- Go to the **Routing Rules** tab and click **Add Rule**.
- In **Inbound Tags**, pick the inbound you created.
- In **Outbound Tags**, select the `PrismoVPN-Out` tag.
- Click **Save** and **Restart Xray**.

Now all traffic for that inbound will go through PrismoVPN and exit via your DNS tunnel.

---

## Section 6: 🛠️ System Architecture and How It Works

**PrismoVPN** combines Session Multiplexing, Resolver Balancing, Packet Duplication, a custom ARQ layer, and a Deferred Session Runtime on top of UDP/DNS to avoid the usual limitations of ordinary tunnels.
...
[Issues](https://github.com/prismo/PrismoVPN/issues)

[Pull Requests](https://github.com/prismo/PrismoVPN/pulls)
...
Developed with ❤️ by: [**Prismo**](https://github.com/prismo)
