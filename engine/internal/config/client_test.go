...
import (
	...
	"prismo-dns-go/internal/compression"
)
...
`), 0o644); err != nil {
	...
	if cfg.MTUServersFileName != "prismovpn_success_test_{time}.log" || cfg.MTUServersFileFormat != "{IP} ({DOMAIN}) - UP: {UP_MTU} DOWN: {DOWN-MTU}" {
