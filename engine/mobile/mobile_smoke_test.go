...
// generated by Prismo's ConfigBuilder (kept in sync manually).
const sampleTOML = `
...
// Validates that a TOML payload shaped exactly like the one Prismo's
// Swift ConfigBuilder emits is accepted by PrismoVPN's loader, including
// resolver discovery via the runtime directory.
func TestPrismoGeneratedConfigLoads(t *testing.T) {
	dir := t.TempDir()
